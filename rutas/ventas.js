...
router.get("/ventas",verificarUser,accesoAdmin,mostrar_venta)
router.get("/form_venta",verificarUser,accesoAdmin,form_registro_venta)
router.get("/obtener_lotes/:productoId",verificarUser,obtener_lotes)
...
],verificarUser,accesoAdmin,form_editar_venta)
router.post("/ventas",verificarUser,accesoAdmin,filtrar_venta),
router.get("/anular_venta/:id",verificarUser,accesoAdmin, anularVenta);
router.get("/ventas_anuladas",verificarUser,accesoAdmin,mostrar_anulados)
